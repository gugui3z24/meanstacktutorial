...
A working example can be found [here](http://www.herokutestapp3z24.com/). Additionally, a YouTube tutorial series illustrating how create this application from scratch can be found [here](https://www.youtube.com/playlist?list=PL3vQyqzqjZ637sWpKvniMCxdqZhnMJC1d).
