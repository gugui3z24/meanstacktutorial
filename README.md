...
A working example can be found [here](https://immense-dusk-71112.herokuapp.com/). Additionally, a YouTube tutorial series illustrating how create this application from scratch can be found [here](https://www.youtube.com/playlist?list=PL3vQyqzqjZ637sWpKvniMCxdqZhnMJC1d).
